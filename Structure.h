...
public:
	...
	virtual void push_at(int data, size_t index);            // adds item at the specified index

    virtual void check_capacity(void) = 0;                   // only for DynamicArray, for other structures it does nothing
